...
<table>
    ...
    <tr>
        ...
        <td>
            <audio controls="controls" style="width: 160px;">
                <source src="assets/audios/mls_examples/5800_4872_000001.flac" type="audio/flac">
            </audio>
        </td>
        <td>
            <audio controls="controls" style="width: 160px;">
                <source src="assets/audios/mls_examples/5800_4872_000005.flac" type="audio/flac">
            </audio>
        </td>
        <td>
            <audio controls="controls" style="width: 160px;">
                <source src="assets/audios/mls_results/result_6.wav" type="audio/wav">
            </audio>
        </td>
    </tr>
    <tr>
        <td>four sleep resistance is markedly lowered by a lack of sufficient sleep have a rest period during the day if possible do not sleep longer than eight hours for every hour you are in bed over that time the fat piles on</td>
        <td>
            <audio controls="controls" style="width: 160px;">
                <source src="assets/audios/mls_examples/7555_3213_000115.flac" type="audio/flac">
            </audio>
        </td>
        <td>
            <audio controls="controls" style="width: 160px;">
                <source src="assets/audios/mls_examples/7555_3213_000047.flac" type="audio/flac">
            </audio>
        </td>
        <td>
            <audio controls="controls" style="width: 160px;">
                <source src="assets/audios/mls_results/result_7.wav" type="audio/wav">
            </audio>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <audio controls="controls" style="width: 160px;">
                <source src="assets/audios/mls_examples/10271_11551_000020.flac" type="audio/flac">
            </audio>
        </td>
        <td>
            <audio controls="controls" style="width: 160px;">
                <source src="assets/audios/mls_examples/10271_11427_000001.flac" type="audio/flac">
            </audio>
        </td>
        <td>
            <audio controls="controls" style="width: 160px;">
                <source src="assets/audios/mls_results/result_9.wav" type="audio/wav">
            </audio>
        </td>
    </tr>
